...
export default function CollectionItemDeleteModal({ open, onClose, item }) {
  const { mutateAsync, isPending } = useDeleteCollectionItem();
  ...
  return (
    <DashboardModal
      ...
      onClose={onClose}
      title="Delete Item"
      description="This action will permanently remove the selected collection item."
      size="sm"
    >
