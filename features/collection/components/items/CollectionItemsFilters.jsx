...
export default function CollectionItemsFilters({
  search = "",
  status = "all",
  categoryId = "all",
  sortBy = "createdAt",
  ...
  return (
    <div className="rounded-[24px] bg-white p-6 shadow-[0_10px_30px_rgba(17,24,39,0.04)]">
      <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
        <div>
          <h3 className="text-[20px] font-bold text-[#111827]">Items Table</h3>
          <p className="mt-1 text-sm text-[#6b7280]">
            Search, sort, and manage collection items.
          </p>
        </div>
        ...
        <div className="grid gap-3 sm:grid-cols-2 xl:flex">
          <div className="relative min-w-[240px]">
            ...
            <input
              type="text"
              placeholder="Search item name or slug..."
              value={search}
