    ...
    <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
      <div>
        ...
        <p className="mt-2 max-w-2xl text-sm leading-6 text-[#6b7280]">
          Manage blog articles, publication status, and content updates from one
          place.
        </p>
      </div>
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <button
          onClick={onCreate}
          className="inline-flex items-center gap-2 rounded-xl bg-[#4f7df3] px-4 py-2.5 text-sm font-medium text-white shadow-[0_10px_24px_rgba(79,125,243,0.22)] transition hover:bg-[#3e6ee8]"
        >
          <Download size={16} />
          Create Blog
        </button>
